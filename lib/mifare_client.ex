defmodule Nerves.IO.PN532.MifareClient do
  @moduledoc """
  A client for accessing Mifare-type cards. Builds on `Nerves.IO.PN532.Base`.

  Currently supports accessing card detected and card removed events
  through callbacks.
  ...
  @doc ~S"""
  Handle an event generated by the NFC reader.

  Event can either be :`card_detected` or `:card_lost`
  ...
  """
  @callback handle_event(atom(), map()) :: :ok | {:error, term}

  @doc """
  Run any setup you wish. Given the PID of the NFC Client and a map
  of its state.
  ...
  defmacro __using__(opts \\ []) do
    ...
    quote location: :keep do
      ...
      @behaviour Nerves.IO.PN532.MifareClient
